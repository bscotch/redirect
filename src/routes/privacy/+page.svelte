<section class="post">
	...
	<p>
		Absolutely no data is sent from this site to any remote server, ours or otherwise. That said,
		it's pretty likely that our web host (currently GitHub Pages) logs some data about your visit,
		like your IP address and diagnostic details, but they do not have access to any data you enter
		on the page.
	</p>
	...
	<p>
		Any data entered into forms on this site may be stored locally to add functionality, but won't
		go anywhere else. If you are using the forms to generate redirect URLs, then once those URLs are
